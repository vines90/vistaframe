...
export async function generateMetadata({
  ...
  const languages: Record<string, string> = { "x-default": `/${defaultLocale}/legal/terms` };
  locales.forEach((l) => {
    languages[l === "en" ? "en-US" : l === "zh" ? "zh-CN" : "es-ES"] = `/${l}/legal/terms`;
  });
  return {
    title: dict.legal.termsTitle,
    description: dict.legal.termsBody.slice(0, 160),
    alternates: { canonical: `/${locale}/legal/terms`, languages },
  };
}
